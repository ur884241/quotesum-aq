...
def search_sentence_substring(
    ...
    """
    Finds matching quotes by checking all possible continuous substrings of a sentence.
    A substring is any continuous sequence of words within the sentence.
    ...
    # cum_sums[i] represents the sum of words from start to position i
    ...
    for start in range(num_words):
        for end in range(start + 1, num_words + 1):
            # Calculate substring sum using the cumulative sums
            ...
            if current_sum == target_sum:
                ...
                # A substring is a complete sentence only if it contains the entire sentence
                ...
                quote_data = {
                    ...
                    "strategy_description": "Substring of sentence (any continuous words)"
                }
